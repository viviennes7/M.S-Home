            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse">
                	<ul class="nav navbar-nav navbar-right">
                        ...
                        <li>
                           <a href="https://github.com/viviennes7" target="_blank">
	    			...
	    			<div class="col-md-12">
	    				<div style="background-color: white; padding: 15px; border-radius: 8px">
	    					<div class="container-fluid">
	    					  ...
	    					  <form action="portfolioUpdate" enctype="multipart/form-data" method="post">
	    						<div class="row">
	    							<div class="col-md-12">
	               						<label>제목</label>
										<input type="text" class="form-control" name="subject" placeholder="제목" value="${portfolio.subject}"><br>
									</div>
								</div>
								...
								<div class="row">
	               					<div class="col-md-12">
										<input type="text" class="form-control" name="strapline1" placeholder="ex)팀명 : 대한민국" value="${portfolio.strapline1}">
									</div>
								</div><br>
								...
								<div class="row">
	               					<div class="col-md-12">
										<input type="text" class="form-control" name="strapline2" placeholder="ex)팀원 : 홍길동" value="${portfolio.strapline2}">
									</div>
								</div><br>
								...
								<div class="row">
	               					<div class="col-md-12">
										<input type="text" class="form-control" name="strapline3" placeholder="ex)프로젝트명 : 고조선" value="${portfolio.strapline3}">
									</div>
								</div><br>
								...
								<div class="row">
	               					<div class="col-md-12">
										<input type="text" class="form-control" name="strapline4" placeholder="ex)프로젝트기간 : 2016.01.01~2017.01.01" value="${portfolio.strapline4}">
									</div>
								</div><br>
								...
								<div class="row">
	               					<div class="col-md-12">
										<input type="text" class="form-control" name="strapline5" placeholder="ex)프로젝트소개 : API에 손쉽게 접근 가능" value="${portfolio.strapline5}">
									</div>
								</div><br>
								...
								<div class="row">
									<div class="col-md-12">
   										 <textarea id='edit' name="content">${portfolio.content}</textarea>
									</div>
								</div><br>
								...
								<div class="row" style="text-align: center">
									 <input type="submit" class="btn btn-default btn-fill" data-dismiss="modal" id="write-save" value="Update">
								</div>
					     	  </form>
							</div>
	    				</div>
